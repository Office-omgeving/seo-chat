-- Allow admin-created team accounts while keeping self-signup blocked.
...
BEGIN
  IF NEW.invited_at IS NULL
    ...
    RAISE EXCEPTION 'Nieuwe accounts moeten via een superadmin-uitnodiging of admin-aanmaak worden aangemaakt';
  END IF;
